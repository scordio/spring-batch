 ...
 * array of Strings to Java native types. A bit like the role played by {@link ResultSet}
...
public interface FieldSet {
	...
	/**
	 * Read the '<code>int</code>' value from column with given '<code>name</code>', using
	 * the supplied <code>defaultValue</code> if the field value is blank.
	 * @param name the field {@code name}.
	 * @param defaultValue the value to use if the field value is blank.
	 * @return int containing the value from the specified {@code name}.
	 * @throws IllegalArgumentException if a column with given {@code name} is not
	...
	/**
	 * Read the '<code>long</code>' value at index '<code>index</code>', using the
	 * supplied <code>defaultValue</code> if the field value is blank.
	 * @param index the field index.
	 * @param defaultValue the value to use if the field value is blank.
	 * @return long containing the value from the specified index.
	 * @throws IndexOutOfBoundsException if the index is out of bounds.
	...
	/**
	 * Read the '<code>long</code>' value from column with given '<code>name</code>',
	 * using the supplied <code>defaultValue</code> if the field value is blank.
	 * @param name the field {@code name}.
	 * @param defaultValue the value to use if the field value is blank.
	 * @return long containing the value from the specified {@code name}.
	 * @throws IllegalArgumentException if a column with given {@code name} is not
	 ...
	 * supplied <code>defaultValue</code> if the trimmed string value at index
	 * '<code>index</code>' is blank.
	 * @param index the field index.
	 * @param defaultValue the value to use if the field value is blank.
	 * @return {@link BigDecimal} containing the value from the specified index.
	 * @throws IndexOutOfBoundsException if the index is out of bounds.
	 ...
	 * returning the supplied <code>defaultValue</code> if the trimmed string value at
	 * index '<code>index</code>' is blank.
	 * @param name the field {@code name}.
	...
	/**
	 * Read the <code>java.sql.Date</code> value in given format from column with given
	 * <code>name</code>.
	 * @param name the field {@code name}.
	 * @return {@link Date} containing the value from the specified {@code name}.
	 * @throws IllegalArgumentException if a column with given {@code name} is not defined
	 * or if the value is not parseable
	 * @throws NullPointerException if the value is empty
	 */
	 ...
	 * @return {@link Date} containing the value from the specified {@code name}.
	 * @throws IllegalArgumentException if a column with given {@code name} is not defined
	 * or if the specified field cannot be parsed
	 *
	 */
